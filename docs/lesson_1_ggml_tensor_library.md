...
## 3. Hệ thống 35 kiểu dữ liệu

GGML định nghĩa `enum ggml_type` với **35 kiểu dữ liệu** hoạt động (tính đến phiên bản hiện tại, `GGML_TYPE_COUNT = 42` bao gồm 7 slot đã bị xóa bỏ), chia thành 7 nhóm:
...
### 3.6. Nhóm Ternary Quantization (TQ)

| Enum | Tên | Bits/trọng số | Mô tả |
|:---|:---|:---|:---|
| `GGML_TYPE_TQ1_0` | Ternary quant 1 | ~1.69 | Ternary {-1, 0, +1} packed dạng 1 |
| `GGML_TYPE_TQ2_0` | Ternary quant 2 | ~2.00 | Ternary packed dạng 2 |

### 3.7. Nhóm mới (MX/NVFP, 1-bit)

| Enum | Tên | Bits/trọng số | Mô tả |
|:---|:---|:---|:---|
| `GGML_TYPE_MXFP4` | MXFP4 | ~4.5 | Microscaling FP4 (MX format) |
| `GGML_TYPE_NVFP4` | NVFP4 | ~4.5 | NVIDIA FP4 (E4M3 scale) |
| `GGML_TYPE_Q1_0` | 1-bit symmetric | ~1.5 | 1-bit block quantization |
