...
Dưới đây là giáo trình tự học gồm 10 bài học đi từ lý thuyết nền tảng đến chi tiết hiện thực và tối ưu hiệu năng của `llama.cpp`.
...
* **[Bài 1: GGML - Thư viện Tensor bằng C không phụ thuộc](lesson_1_ggml_tensor_library)**
  * Cấu trúc `ggml_tensor`, hệ thống 39 kiểu dữ liệu, arena memory allocation.
